...
- **Hindi:** Gemma 4 correctly uses Devanagari script without prompting, understands formal vs. casual registers, and handles cultural nuance
...
1. Tripathi, K., Gothi, R., & Wasnik, P. (2024). *Enhancing Whisper's Accuracy and Speed for Indian Languages through Prompt-Tuning and Tokenization*. arXiv.
2. Biswas, A., et al. (2025). *Adapting Whisper for low-resource Hindi-English Code-Mixed ASR*. INTERSPEECH.
3. Bhogale, K., et al. (2023). *Vistaar: Diverse Benchmarks and Training Sets for Indian Language ASR*. INTERSPEECH.
4. IIT Bombay CFILT. (2023). *Survey: Automatic Speech Recognition For Indian Languages*.
5. DevSaquib. (2026). *I Tested Gemma 4 and GPT-4o-mini on Indian Language Tasks*. Dev.to.
6. MindStudio. (2026). *What Is Google Gemma 4? The Apache 2.0 Open-Weight Model With Native Audio and Vision*.
7. Davis, C. (2025). *A Comparative Study of WARC-GPT and a Custom Pipeline*. Code4Lib Journal.
8. SISSA. (2025). *Leveraging Knowledge Graph-Enhanced RAG and LLMs for Historical Archival Analysis*.

### Ethical & Legal Sources

9. Oral History Association. *Guidelines for Social Justice Oral History Work*.
10. National Park Service. *Considering Legal and Ethical Issues in Oral History*.
11. AIATSIS. (2020). *Guidelines for Ethical Research in Australian Indigenous Studies*.
12. Schellnack-Kelly, I.S. (2022). *Research ethics to consider when collecting oral histories*. Scielo.
13. Oral History Society (UK). *Is your oral history legal and ethical?*.
14. Oral History Australia. *Ethics and university research*.

### Institutional & Government Sources

15. PIB Delhi. (2026). *Digital Cultural Governance and Monitoring of Cultural Initiatives*.
16. NCBS Archives. (2026). *Program for the Archiving of Science and Technology (PAST) 2025-26*.
17. NIILM University. *Digital Preservation of Traditional Knowledge: Safeguarding Indigenous Heritage through Modern Tools*.

### Technical Documentation

18. ChromaDB Documentation. *The open-source search infrastructure for AI*.
19. DataCamp. (2023). *Learn How to Use Chroma DB: A Step-by-Step Guide*.
20. AltexSoft. (2026). *The Good and Bad of ChromaDB for RAG: Based on Our Experience*.
